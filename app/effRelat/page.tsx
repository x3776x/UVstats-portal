...
export default function EffRelatPage() {
    const [activeKey, setActiveKey] = useState<EffRelatModelKey | 'ABOUT'>('ABOUT');
        ...
        <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
            ...
            <aside className="w-full md:w-72 bg-white border-r border-gray-200 shadow-sm">
                <div className="p-4 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <h2 className="text-xl font-bold text-gray-800">Eff Relat.</h2>
                </div>

                <nav className="flex overflow-x-auto md:flex-col p-4 gap-2 md:overflow-visible">
                    {/*Models*/}
                    { EFF_MODELS.map((model) => (
                        <SidebarButton
                            key={model.key}
