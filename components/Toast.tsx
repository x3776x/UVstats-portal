...
export default function Toast({ message, type, isVisible, onClose}: ToastProps) {
    ...
    return (
        <div 
            className={`fixed bottom-6 right-6 z-50 flex items-center w-full max-w-xs p-4 space-x-3 text-gray-700 bg-white border rounded-xl shadow-2xl transition-all duration-300 transform ${
