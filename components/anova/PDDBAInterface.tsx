...
export default function PDDBAInterface() {
    ...
    const [resultados, setResultados] = useState<AnovaResultPDDBA | null>(null);
        ...
        <div className="space-y-8">
            ...
            {method === 'excel' && (
                <div className="p-6 bg-gray-50 rounded-lg border border-gray-200 space-y-3">
                    ...
                    <input
                        ...
                        onChange={async (e) => {
                            ...
                            try {
                                ...
                                const blk = Math.max(...mappedData.map(d => d.bloque));
                                
                                setNivelesA(a.toString());
                                setNivelesB(b.toString());
                                setBloques(blk.toString()); 
                                setIsTableGenerated(true);
                    ...
                    <div className="text-xs text-gray-500 mt-2">
                        ...
                        <code className="bg-gray-200 px-2 py-1 rounded">Factor A (Parcela Principal) | Factor B (Sub-parcela) | Bloque | Rendimiento</code>
                    </div>
                </div>
            )}
            ...
            {method === 'manual' && !isTableGenerated && (
                <div className="p-6 bg-gray-50 rounded-lg border border-gray-200 space-y-4">
                    <h3 className="font-semibold text-gray-800">Parámetros de Parcelas Divididas (DBA)</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label className="block mb-1 text-sm text-gray-600">Bloques</label>
            ...
            {resultados && (
                <div className="mt-8 p-6 bg-white border border-gray-200 rounded-xl shadow-lg fade-in">
                    <h3 className="text-xl font-bold text-gray-800 mb-4 border-b pb-2">Tabla ANOVA (Parcelas Divididas DBA)</h3>
                        ...
                        <table className="w-full text-sm text-left text-gray-700 border-collapse">
                            ...
                            <tbody>
                                ...
                                <tr className="border-b hover:bg-gray-50">
                                    <td className="px-4 py-3 font-medium pl-8">Bloques</td>
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-3">
                        <div className="p-3 bg-purple-50 border-l-4 border-purple-500 rounded-r-lg">
                            <p className="text-xs text-purple-900 font-semibold">Bloques:</p>
                            <p className="text-sm font-bold">{resultados.conclusionBloques}</p>
                        </div>
                        <div className="p-3 bg-blue-50 border-l-4 border-blue-500 rounded-r-lg">
                            <p className="text-xs text-blue-900 font-semibold">Factor A:</p>
                            <p className="text-sm font-bold">{resultados.conclusionA}</p>
                        </div>
                        <div className="p-3 bg-green-50 border-l-4 border-green-500 rounded-r-lg">
                            <p className="text-xs text-green-900 font-semibold">Factor B:</p>
                            <p className="text-sm font-bold">{resultados.conclusionB}</p>
                        </div>
                        <div className="p-3 bg-orange-50 border-l-4 border-orange-500 rounded-r-lg">
                            <p className="text-xs text-orange-900 font-semibold">Interacción A×B:</p>
                            <p className="text-sm font-bold">{resultados.conclusionAB}</p>
                        </div>
                    </div>
                </div>
            )}
