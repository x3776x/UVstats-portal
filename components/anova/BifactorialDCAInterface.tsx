...
export default function BifactorialDCAInterface() {
    ...
    const [resultados, setResultados] = useState<AnovaResultBiDCA | null>(null);
        ...
        <div className="space-y-8">
            ...
            {method === 'excel' && (
                <div className="p-6 bg-gray-50 rounded-lg border border-gray-200 space-y-3">
                    ...
                    <div className="text-xs text-gray-500 mt-2">
                        ...
                        <code className="bg-gray-200 px-2 py-1 rounded">Factor A | Factor B | Repetición | Rendimiento</code>
                    </div>
                </div>
            )}
            ...
            {method === 'manual' && !isTableGenerated && (
                <div className="p-6 bg-gray-50 rounded-lg border border-gray-200 space-y-4">
                    <h3 className="font-semibold text-gray-800">Parámetros del Diseño Bifactorial</h3>
            ...
            {resultados && (
                <div className="mt-8 p-6 bg-white border border-gray-200 rounded-xl shadow-lg fade-in">
                    <h3 className="text-xl font-bold text-gray-800 mb-4 border-b pb-2">Tabla ANOVA (Bifactorial DCA)</h3>
                        ...
                        <table className="w-full text-sm text-left text-gray-700 border-collapse">
                            ...
                            <tbody>
                                ...
                                <tr className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-3 text-right font-bold text-purple-600">{resultados.fCalcB.toFixed(4)}</td>
                    ...
                    <div className="mt-6 space-y-3">
                        ...
                        <div className="p-3 bg-purple-50 border-l-4 border-purple-500 rounded-r-lg">
                            <p className="text-sm text-purple-900"><b>Factor B:</b> {resultados.conclusionB}</p>
                        </div>
